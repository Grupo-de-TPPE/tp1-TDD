...
def testaTipoAcessoPorPlaca2():
    estacionamento[0].AddAcesso('RM3A9', '20:00', '07:00')
    assert estacionamento[0].FindTipoAcesso('RM3A9') == 'Noturna'
...
def testaTipoAcessoPorPlaca4():
    estacionamento[0].AddAcesso('HI139', '08:30', '08:56')
    assert estacionamento[0].FindTipoAcesso('HI139') == '0:26'
